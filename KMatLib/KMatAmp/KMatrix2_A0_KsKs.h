#if !defined(KMATRIX2_A0_KSKS)
#define KMATRIX2_A0_KSKS
...
class KMatrix2_A0_KsKs: public UserAmplitude<KMatrix2_A0_KsKs> {
    public:
        KMatrix2_A0_KsKs(): UserAmplitude<KMatrix2_A0_KsKs>() {}
        KMatrix2_A0_KsKs(const vector<string> &args);
        ...
        string name() const {return "KMatrix2_A0_KsKs";}
