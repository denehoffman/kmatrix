...
ROOTDataReaderBootstrap::ROOTDataReaderBootstrap(const vector<string> &args)
    : UserDataReader<ROOTDataReaderBootstrap>(args), m_eventCounter(0),
      m_useWeight(false) {
...
void ROOTDataReaderBootstrap::resetSource() {
...
Kinematics *ROOTDataReaderBootstrap::getEvent() {
...
unsigned int ROOTDataReaderBootstrap::numEvents() const {
